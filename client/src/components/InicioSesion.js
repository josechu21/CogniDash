                            ...
                            <div className="card" style={{ borderRadius: '1rem' }}>
                                <div className="row g-0">
                                    <div className="col-md-6 col-lg-5 d-none d-md-block">
                                        <h1>CogniDash</h1>
                                        <p className="text-black my-4">Bienvenid@ a CogniDash, una plataforma de visualización de datos.</p>
                                    ...
                                    <div className="col-md-6 col-lg-7 d-flex align-items-center">
                                        <div className="card-body p-4 p-lg-5 text-white bg-dark" style={{ borderRadius: '0 1rem 1rem 0' }}>
                                            <form onSubmit={handleSubmit}>
                                                ...
                                                <hr className="my-4" />
                                                <p className="mb-5 pb-lg-2 text-white" style={{ color: '#393f81' }}>¿Aún no tienes una cuenta? <a href="/cognidash/nueva-cuenta" style={{ color: '#393f81' }}>Solicita una aquí</a></p>
                                            </form>
