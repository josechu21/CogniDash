...
const CurvaRoc = ({titulo, setTitulo, labelEjeX, setLabelEjeX, labelEjeY, setLabelEjeY, estilo, setEstilo, tema, setTema}) => {
    ...
    return (
        <div>
            <div className="mb-3">
                <label htmlFor="tituloCurvaRoc">Título de la gráfica(si no establece uno se asignará por defecto)</label>
            ...
            <div className="mb-3">
                <label htmlFor="estiloCurvaRoc">Estilo de gráfica</label>
                <select className="form-select mb-2" id='estiloCurvaRoc' name='estiloCurvaRoc' value={estilo} onChange={handleEstiloChange}>
                ...
                <label htmlFor="temaCurvaRoc">Tema de color</label>
                <select className="form-select mb-2" id='temaCurvaRoc' name='temaCurvaRoc' value={tema} onChange={handleTemaChange}>
            ...
            <div className="mb-3">
                <label htmlFor="EjeXCurvaRoc">Etiqueta del eje X (si no establece una se asignará por defecto)</label>
            ...
            <div className="mb-3">
                <label htmlFor="EjeYCurvaRoc">Etiqueta del eje Y (si no establece una se asignará por defecto)</label>
