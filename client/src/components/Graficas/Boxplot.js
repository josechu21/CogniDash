...
const Boxplot = ({titulo, setTitulo, labelEjeX, setLabelEjeX, valueEjeX, setValueEjeX, labelEjeY, setLabelEjeY, valueEjeY, setValueEjeY, estilo, setEstilo, tema, setTema}) => {
    ...
    return (
        <div>
            ...
            <div className="mb-3">
                <label htmlFor="estiloBoxplot">Estilo de gráfica</label>
                <select className="form-select mb-2" id='estiloBoxplot' name='estiloBoxplot' value={estilo} onChange={handleEstiloChange}>
                ...
                <label htmlFor="temaBoxplot">Tema de color</label>
                <select className="form-select mb-2" id='temaBoxplot' name='temaBoxplot' value={tema} onChange={handleTemaChange}>
